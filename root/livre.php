...
<head>
    ...
    <title>Livres - MindScrolls</title>
...
<body class="bg-image">
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <form method="GET" action="livre.php" class="form-inline my-2 my-lg-0" >
                    ...
                    if(isset($result)) {
                        if(mysqli_num_rows($result) > 0) {
                            while($row = mysqli_fetch_assoc($result)) {
                                ...
                                echo '<span style="font-weight:bold; color:white; text-decoration:underline;">' . ($availability ? "Disponible" : "Indisponible") . '</span>';
                                echo '</div>';
                                echo '</div>';
                            }
                        }
